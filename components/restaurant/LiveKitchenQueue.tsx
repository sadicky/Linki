    ...
    <div className="space-y-8 pb-16">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-3 py-2 bg-white hover:bg-slate-50 text-slate-700 rounded-xl text-xs font-semibold border border-slate-200 shadow-2xs transition-colors cursor-pointer"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {activeOrders.map((order) => {
              ...
              return (
                <div
                  key={order.id}
                  className={`bg-white rounded-2xl p-5 border flex flex-col justify-between gap-4 transition-all shadow-xs ${
                    isNew
                    ...
                    {order.statut === "en_attente" && (
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <button
                          ...
                          disabled={isPending}
                          className="py-2.5 px-3 bg-slate-100 hover:bg-rose-50 text-slate-600 hover:text-rose-700 font-semibold text-xs rounded-xl flex items-center justify-center gap-1.5 border border-slate-200 transition-all cursor-pointer"
                        >
      ...
      {pastOrders.length > 0 && (
        <div className="space-y-4 pt-6 border-t border-slate-200">
          ...
          <div className="divide-y divide-slate-100 bg-white rounded-2xl border border-slate-200 p-4 shadow-2xs">
